...
namespace MernisServiceReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference.KPSPublicSoap>, MernisServiceReference.KPSPublicSoap
    {
        ...
        internal Task<bool> TCKimlikNoDogrulaAsync(long identityNumber, string firstName, string v, long v1)
        {
            throw new NotImplementedException();
        }

        internal bool TCKimlikNoDogrulaAsync(long identityNumber, string v1, string v2, object year)
        {
            throw new NotImplementedException();
        }
